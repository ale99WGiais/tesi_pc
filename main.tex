...
{\tiny }				\includegraphics[width=0.93\textwidth]{img/polloPallido.eps}\vfil}\vss}
	...
	\begin{center}  
		...
		\rule{10cm}{.4pt}\\
		\medskip\begin{Large}
			{}\\    % Eventualmente Classe Umanistica
			\medskip
			\vspace{\stretch{0.6}}
...
\paragraph{} La Protezione Civile del comune di San Vito al Tagliamento attualmente utilizza esclusivamente moduli cartacei per la gestione delle proprie attività, il tracciamento della partecipazione delle squadre e il mantenimento delle informazioni riguardanti il proprio inventario. 
...
\begin{lstlisting}[language=Python, caption=POST do\logout]
